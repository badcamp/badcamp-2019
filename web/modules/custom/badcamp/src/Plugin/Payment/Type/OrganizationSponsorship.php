 ...
 *
 * @PaymentType(
 *   id = "badcamp_payment_organization_sponsorship",
 *   label = @Translation("Organzation Sponsorship"),
 * )
 */
class OrganizationSponsorship extends PaymentTypeBase {
  ...
  public function getPaymentDescription() {
    return new TranslationWrapper('Organization Sponsorship');
  }
